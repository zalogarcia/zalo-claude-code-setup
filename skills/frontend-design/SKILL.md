...
Avoid the stock looks that generated interfaces fall back on, unless the brief or an existing brand asks for one: overused font families (Inter, Roboto, Arial, system fonts), purple gradients on white backgrounds, a cream or off-white page background, italic accent words in headlines, numbered "01/02/03" section labels, monospace labels, and pill-shaped buttons. If a draft lands on one of these by default, replace it with a choice specific to this context.
